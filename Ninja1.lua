...
if hash or Bot(msg) or DevNinja1(msg) or DevBotsIs(msg) then    
return true  
else  
return false  
end  
...
if hash or Bot(msg) or DevNinja1(msg) or DevBot(msg) or DevBotsIs(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevNinja1(msg) or DevBot(msg) or DevBotsIs(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevNinja1(msg) or DevBot(msg) or BasicConstructor(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevNinja1(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevNinja1(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevNinja1(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
if DevNinja1e(user_id) == true then
var = true
elseif DevNinja1(user_id) == true then
var = true
...
elseif DevNinja1e(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
...
function Ninja1_Started_Bot(msg,data) -- بداية العمل
if msg then
...
local Ninja1_Msg = database:sismember(bot_id.."List:Filter:text"..msg.chat_id_,text) 
if Ninja1_Msg then    
...
function Function_Ninja1(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Ninja1, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Ninja1, nil)
return false 
end
...
if text == ("الثانويين") and DevNinja1(msg) then
...
if text == ("مسح قائمه العام") and DevNinja1(msg) then
database:del(bot_id.."GBan:User")
database:del(bot_id.."GMuted:User")
send(msg.chat_id_, msg.id_, "\n✫: تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين") and DevNinja1(msg) then
...
if text == ("قائمه العام") and DevNinja1(msg) then
...
if text == ("قائمه كتم عام") and DevNinja1(msg) then
...
if text == ("المطورين") and DevNinja1(msg) then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevNinja1(msg) then
function Function_Ninja1(extra, result, success)
...
if text and text:match("^حظر عام @(.*)$")  and DevNinja1(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevNinja1(msg) then
...
if text == ("كتم عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevNinja1(msg) then
function Function_Ninja1(extra, result, success)
if result.sender_user_id_ == tonumber(Id_Sudo) then
send(msg.chat_id_, msg.id_, "✫: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور البوت الاساسي \n")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevNinja1(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevNinja1(msg) then
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevNinja1(msg) then
function Function_Ninja1(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevNinja1(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevNinja1(msg) then
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevNinja1(msg) then
function Function_Ninja1(extra, result, success)
...
if text and text:match("^اضف مطور @(.*)$") and DevNinja1(msg) then
...
if text and text:match("^اضف مطور (%d+)$") and DevNinja1(msg) then
local userid = text:match("^اضف مطور (%d+)$")
database:sadd(bot_id.."Sudo:User", userid)
Reply_Status(msg,userid,"reply","✫: تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevNinja1(msg) then
function Function_Ninja1(extra, result, success)
...
if text and text:match("^حذف مطور @(.*)$") and DevNinja1(msg) then
...
if text and text:match("^حذف مطور (%d+)$") and DevNinja1(msg) then
...
local Ninja1rt = database:get(bot_id.."Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if Ninja1rt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n✫: تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif Ninja1rt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n✫: تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif Ninja1rt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n✫: تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Manager"..msg.chat_id_,result.sender_user_id_)  
elseif Ninja1rt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n✫: تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
if result.id_ then
local Ninja1rt = database:get(bot_id.."Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if Ninja1rt == "مميز" and Addictive(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✫:  العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'Ninja1')..') '
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevNinja1(msg) then 
...
if text == ("ردود المطور") and DevNinja1(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n✫: قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and DevNinja1(msg) then 
send(msg.chat_id_, msg.id_,"✫:  ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevNinja1(msg) then 
...
if text == 'كشف' and tonumber(msg.reply_to_message_id_) > 0 and
                    not database:get(bot_id .. 'Ninja1:Lock:ID:Bot' .. msg.chat_id_) then
                    function Function_Ninja1(extra, result, success)
                        tdcli_function({
                            ID = "GetUser",
...
if text == "تفعيل المغادره" and DevNinja1(msg) then   
database:del(bot_id.."Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"✫: تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevNinja1(msg) then  
...
if database:get(bot_id.."Status:Bc") and not DevNinja1(msg) then 
...
if text == "تفعيل الاذاعه" and DevNinja1(msg) then  
database:del(bot_id.."Status:Bc") 
send(msg.chat_id_, msg.id_,"\n✫: تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevNinja1(msg) then  
...
if text == "تنظيف المشتركين" and DevNinja1(msg) then
...
if text == "تنظيف الكروبات" and DevNinja1(msg) then
...
if text == ("تحديث السورس") and DevNinja1(msg) then  
send(msg.chat_id_,msg.id_,'✫: تم التحديث')
os.execute('rm -rf Ninja1.lua')
os.execute('rm -rf start.lua')
os.execute('wget https://raw.githubusercontent.com/Ninja1-DeV/Ninja1/main/Ninja1.lua')
os.execute('wget https://raw.githubusercontent.com/Ninja1-DeV/Ninja1/main/start.lua')
dofile('Ninja1.lua')  
return false
end
if text == "راسلني" then
...
zh = https.request('https://Ninja1-api.ml/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n✫️ : قائمه الزخرفه \n — — — — — — — — — \n"
i = 0
...
gk = https.request('https://Ninja1-api.ml/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
...
ge = https.request('https://Ninja1-api.ml/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
send(msg.chat_id_, msg.id_, ag.ok.hso)
end
if text == 'السيرفر' and DevNinja1(msg) then 
...
data,res = https.request('https://Ninja1-api.ml/infoInstagram.php?username='..URL.escape(Textni)..'')
if res == 200 then
...
data,res = https.request('https://Ninja1-api.ml/movie.php?serch='..URL.escape(Textm)..'')
if res == 200 then
...
if text == "غنيلي" then
data,res = https.request('https://Ninja1-api.ml/audios.php')
if res == 200 then
...
st = https.request('https://Ninja1-api.ml/ImageInfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://Ninja1-api.ml/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
if text == 'جلب نسخه احتياطيه' and DevNinja1(msg) then
local list = database:smembers(bot_id..'Chek:Groups')  
local memo = database:smembers(bot_id..'UsersBot')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
...
if text == 'الملفات' and DevNinja1(msg) then
t = '✫: جميع الملفات : \n — — — — — — — — — \n'
i = 0
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
...
if DevNinja1(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Ninja1-DeV/files_Ninja1/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevNinja1(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Ninja1-DeV/files_Ninja1/main/files_Ninja1/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevNinja1(msg) then
...
if text == "مسح جميع الملفات" and DevNinja1(msg) then
os.execute("rm -fr Files/*")
send(msg.chat_id_,msg.id_,"✫: تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevNinja1(msg) then
...
if text == 'حذف كليشه المطور' and DevNinja1(msg) then
database:del(bot_id..'Text_Dev')
send(msg.chat_id_, msg.id_,'✫:  تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevNinja1(msg) then
...
if text == 'رفع النسخه الاحتياطيه' and DevNinja1(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and DevNinja1(msg) then
dofile("Ninja1.lua")  
send(msg.chat_id_, msg.id_, "✫: تم التحديث")
end
if text == 'السورس' or text == 'سورس' or text == 'ياسورس' or text == 'يا سورس' then  
local url,res = https.request('https://Ninja1-api.ml/ChatMember.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevNinja1(msg) then
...
if not DevNinja1(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Filter"..msg.sender_user_id_) then
...
if DevNinja1(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text and text:match("^- تغير الاشتراك ✫ .$") and DevNinja1(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✫: حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^- تغير رساله الاشتراك ✫ .$") and DevNinja1(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✫: حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ✫ ." and DevNinja1(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "✫: تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^- تعين قناة الاشتراك ✫ .$") and DevNinja1(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✫: حسنآ ارسل لي معرف القناة')
return false  
end
if text == "- تفعيل الاشتراك الاجباري ✫ ." and DevNinja1(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "- تعطيل الاشتراك الاجباري ✫ ." and DevNinja1(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "✫: تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "- الاشتراك الاجباري ✫ ." and DevNinja1(msg) then  
...
if text == ("قائمه المكتومين العام ✫") and DevNinja1(msg) then
local list = database:smembers(bot_id.."GMuted:User")
...
------------------------------------------------------------------------
if text then
local Ninja1_Msg = database:sismember(bot_id.."List:Filter:text"..result.chat_id_,text) 
if Ninja1_Msg then    
