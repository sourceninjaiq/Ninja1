...
user.Source  = "/root/Ninja1"
local url , res = https.request('https://api.th3Ninja1.com/GetID/?Array='..JSON.encode(user))
print(res)
if res ~= 200 then
...
Ninja1 = Token:match("(%d+)")
redis:mset(
Ninja1..":VERSION",GetUser.information.Source_version,
Ninja1..":SUDO_ID:",GetUser.information.id,
Ninja1..":DataCenter:",GetUser.information.DataCenter,
Ninja1..":UserNameBot:",BOT_User,
Ninja1..":ApiSource",GetUser.information.WebSite,
Ninja1..":NameBot:","الزعيم",
"TH3Ninja1_INSTALL","Yes"
)
redis:hset(Ninja1..'username:'..GetUser.information.id,'username','@'..GetUser.information.username:gsub('_',[[\_]]))
info = {} 
...
Ninja1 = Token:match("(%d+)")
our_id = tonumber(Ninja1)
ApiNinja1 = redis:get(Ninja1..":ApiSource")
ApiToken = "https://api.telegram.org/bot"..Token
Bot_User = redis:get(Ninja1..":UserNameBot:")
SUDO_ID = tonumber(redis:get(Ninja1..":SUDO_ID:"))
if not SUDO_ID then io.popen("rm -fr ./inc/Token.txt") end
SUDO_USER = redis:hgetall(Ninja1..'username:'..SUDO_ID).username
version = redis:get(Ninja1..":VERSION")
DataCenter = redis:get(Ninja1..":DataCenter:")
...
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..Ninja1..')\027[0;32m\n'
...
..'¦ Api_Src->: \27[1;34m'..ApiNinja1..'\027[0;32m\n'
...
if not redis:get(Ninja1..":Check_Bot:"..W) then
Rgz,res=https.request(ApiNinja1..Tkml..W)
if res == 200 and Rgz == "SendMsg" then redis:setex(Ninja1..":Check_Bot:"..W,1800,true) return false else return Rgz end 
end 
end
...
if msg.type == "pv" and redis:get(Ninja1..':mute_pv:'..msg.sender_user_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end
if msg.type ~= "pv" and redis:get(Ninja1..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood') then
print("\27[1;31mThis Flood Sender ...\27[0")
Del_msg(msg.chat_id_,msg.id_)
return false
end
if redis:get(Ninja1..'group:add'..msg.chat_id_) then 
...
and redis:get(Ninja1.."lock_cleaner"..msg.chat_id_) then
print("Clener >>> ")
redis:sadd(Ninja1..":IdsMsgsCleaner:"..msg.chat_id_,msg.id_)
Timerr = redis:get(Ninja1..':Timer_Cleaner:'..msg.chat_id_)
if Timerr then 
Timerr = tonumber(Timerr)
Timerr = 60*60*Timerr
end
redis:setex(Ninja1..":SetTimerCleaner:"..msg.chat_id_..msg.id_,Timerr or 21600,true)  
end
...
if not redis:get(Ninja1..":SetTimerCleaner:"..msg.chat_id_..v) then
Del_msg(msg.chat_id_,v)
redis:srem(Ninja1..":IdsMsgsCleaner:"..msg.chat_id_,v)
...
if msg.GroupActive and redis:get(Ninja1..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
end
return false 
end 
...
msg.TheRankCmd = redis:get(Ninja1..":RtbaNew1:"..msg.chat_id_) or 'المطور الاساسي' 
msg.TheRank = redis:get(Ninja1..":RtbaNew1:"..msg.chat_id_) or 'مطور اساسي 👨🏻‍✈️' 
msg.Rank = 1
elseif redis:sismember(Ninja1..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(Ninja1..":RtbaNew2:"..msg.chat_id_) or 'المطور'
msg.TheRank = redis:get(Ninja1..":RtbaNew2:"..msg.chat_id_) or 'مطور البوت 👨🏽‍💻'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(Ninja1..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(Ninja1..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي'
msg.TheRank = redis:get(Ninja1..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي 👲🏼'
msg.Rank = 11
elseif msg.GroupActive and redis:sismember(Ninja1..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(Ninja1..":RtbaNew4:"..msg.chat_id_) or 'المنشىء'
msg.TheRank = redis:get(Ninja1..":RtbaNew4:"..msg.chat_id_) or 'المنشىء 👷🏽'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(Ninja1..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(Ninja1..":RtbaNew5:"..msg.chat_id_) or 'المدير' 
msg.TheRank = redis:get(Ninja1..":RtbaNew5:"..msg.chat_id_) or 'مدير البوت 👨🏼‍⚕️' 
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(Ninja1..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(Ninja1..":RtbaNew6:"..msg.chat_id_) or 'الادمن'
msg.TheRank = redis:get(Ninja1..":RtbaNew6:"..msg.chat_id_) or 'ادمن في البوت 👨🏼‍🎓'
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(Ninja1..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRank = redis:get(Ninja1..":RtbaNew7:"..msg.chat_id_) or 'عضو مميز'
msg.Rank = 6
...
local lock_bots = redis:get(Ninja1..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(Ninja1..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(Ninja1..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(Ninja1..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(Ninja1..':WELCOME_BOT'),[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(Ninja1..':NameBot:')..[[ 🎖
...
if not msg.Special and not msg.Admin and redis:get(Ninja1.."lock_Add"..msg.chat_id_) then
...
if redis:get(Ninja1.."lock_check"..msg.chat_id_) and not redis:get(Ninja1..":TqeedUser:"..msg.chat_id_..Senderid) then
...
if msg.Special or msg.Admin then redis:srem(Ninja1..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return false end
...
if msg.Special then redis:srem(Ninja1..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(Ninja1..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.Ninja1 then 
if msg.text and ScriptFile.iNinja1 then
XNinja1 = ScriptFile.Ninja1
local list = redis:hgetall(Ninja1..":AwamerBotArray:"..msg.chat_id_)
for Ninja12,k in pairs(list) do
Text = msg.text
Text2 = k
if Text:match(Ninja12) then 
local amrr = {Text:match(Ninja12)}
local AmrOld = redis:hgetall(Ninja1..":AwamerBotArray2:"..msg.chat_id_)
amrnew = "" amrold = ""
...
GetMsg = ScriptFile.iNinja1(msg,{Text:match(Text2)})
if GetMsg then
...
Text = Text:gsub("ک","ك")
Text = Text:gsub("ه‍","ه")
if Text:match(Ninja1) then -- Check Commands To admin
AF = CheckBotA(msg) if AF then return sendMsg(msg.chat_id_,msg.id_,AF) end 
GetMsg = ScriptFile.iNinja1(msg,{Text:match(Ninja1)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",Ninja1.." | Plugin is: \27[1;32mScript.lua\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
return false
end 
end
...
if ScriptFile.dNinja1 then
if ScriptFile.dNinja1(msg) == false then
return false
end
...
if Plug.Ninja1 then 
if msg.text and Plug.iNinja1 then
for k, Ninja1 in pairs(Plug.Ninja1) do
if msg.text:match(Ninja1) then
local GetMsg = Plug.iNinja1(msg,{msg.text:match(Ninja1)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",Ninja1.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
if Plug.dNinja1 then
Plug.dNinja1(msg)
print("\27[1;35m¦Msg_IN_Process : \27[1;32"..name.."\27[0m")
end
else
print("The File "..name.." Not Runing in The Source Ninja1")
end 

end
else
print("The File Script.lua Not Runing in The Source Ninja1")
end
end
...
redis:srem(Ninja1..'users',msg.sender_user_id_)
end
...
if redis:get(Ninja1..":propin"..msg.chat_id_) == msg.content_.text_ then
redis:del(Ninja1..":propin"..msg.chat_id_)
...
if redis:get(Ninja1..'group:add'..data.chat_.id_) then
redis:set(Ninja1..'group:name'..data.chat_.id_,data.chat_.title_)
end
elseif data.ID == "UpdateChannel" then  
if data.channel_.status_.ID == "ChatMemberStatusKicked" then 
if redis:get(Ninja1..'group:add-100'..data.channel_.id_) then
local linkGroup = (redis:get(Ninja1..'linkGroup-100'..data.channel_.id_) or "")
local NameGroup = (redis:get(Ninja1..'group:name-100'..data.channel_.id_) or "")
...
redis:mset(
Ninja1..'group:name'..k,IDS.Title,
Ninja1..'num_msg_max'..k,5,
Ninja1..'group:add'..k,true,
Ninja1..'lock_link'..k,true,
Ninja1..'lock_spam'..k,true,
Ninja1..'lock_webpage'..k,true,
Ninja1..'lock_markdown'..k,true,
Ninja1..'lock_flood'..k,true,
Ninja1..'lock_bots'..k,true,
Ninja1..'mute_forward'..k,true,
Ninja1..'mute_contact'..k,true,
Ninja1..'mute_document'..k,true,
Ninja1..'mute_inline'..k,true,
Ninja1..'lock_username'..k,true,
Ninja1..'replay'..k,true
)
redis:sadd(Ninja1..'group:ids',k) 

if IDS.Admins then
for user,ID in pairs(IDS.Admins) do
redis:hset(Ninja1..'username:'..ID,'username',user)
redis:sadd(Ninja1..'admins:'..k,ID)
end
end
if IDS.Creator then
for user,ID in pairs(IDS.Creator) do
redis:hset(Ninja1..'username:'..ID,'username',user)
redis:sadd(Ninja1..':MONSHA_BOT:'..k,ID)
end
end
if IDS.Owner then
for user,ID in pairs(IDS.Owner) do
redis:hset(Ninja1..'username:'..ID,'username',user)
redis:sadd(Ninja1..'owners:'..k,ID)
end
end
end
io.popen("rm -fr ../.telegram-cli/data/document/*")
sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'📦*¦* تم رفع آلنسـخهہ‏‏ آلآحتيآطـيهہ\n⚖️*¦* حآليآ عدد مـجمـوعآتگ هہ‏‏يهہ‏‏ *'..redis:scard(Ninja1..'group:ids')..'* 🌿\n✓')
end
elseif data.ID == "UpdateUser" then  
if data.user_.type_.ID == "UserTypeDeleted" then
print("¦ userTypeDeleted")
redis:srem(Ninja1..'users',data.user_.id_)
elseif data.user_.type_.ID == "UserTypeGeneral" then
local CheckUser = redis:hgetall(Ninja1..'username:'..data.user_.id_).username
...
redis:hset(Ninja1..'username:'..data.user_.id_,'username',USERNAME)
end 
end
